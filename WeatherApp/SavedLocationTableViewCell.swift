    ...
    func configureSavedCityCell(cityCurrentForecast:SavedLocation) { 
        ...
        DarkSkyAPIClient.getForecast(locationToPass.latitude, longitude: locationToPass.longitude) { (forecast) in
            ...
            NSOperationQueue.mainQueue().addOperationWithBlock({
                ...
                let currentTempBackground = forecast.temperature
                ...
                background.frame = self.gradientBackView.bounds
                self.gradientBackView.layer.addSublayer(background)
...
//        print("entered didMoveToSuper method in cell class")
...
//        background.frame = self.gradientBackView.bounds
//        gradientBackView.layer.addSublayer(background)
//        //        self.gradientBackView.layer = background
//        //self.gradientBackView.layer.backgroundColor = background.colors
...
//        
//        print("finished didMoveToSuper method in cell class")
//    }
}
