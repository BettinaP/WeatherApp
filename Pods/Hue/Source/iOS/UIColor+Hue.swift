...
//   guard let RGB = CGColor(
//    //where RGB.count == 3 else {
//    //rgbComponents() where RGB.count == 3 else {
//        //.components where RGB.count == 3 else {
//        
//   // guard let RGB = self.CGColor.components where RGB.count == 3 else {
//    //guard let RGB = cgColor.components where RGB.count == 3 else {
//      return [0,0,0]
//    }
//    return RGB
//  }
...
//
//  public func gradient(_ transform: ((_gradient: inout CAGradientLayer) -> CAGradientLayer)? = nil) -> CAGradientLayer {
//    var gradient = CAGradientLayer()
//    gradient.colors = self.map { $0.CGColor }
//
//    if let transform = transform {
//      gradient = transform(_gradient: &gradient)
//    }
//
//    return gradient
//  }
