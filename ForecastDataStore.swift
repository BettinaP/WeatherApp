...
//        }
    ...
    func generateTestData(){
        ...
        let savedLocation3 = NSEntityDescription.insertNewObjectForEntityForName(SavedLocation.entityName, inManagedObjectContext: self.managedObjectContext) as! SavedLocation
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = NSBundle.mainBundle().URLForResource("SavedLocationsModel", withExtension: "momd")!
